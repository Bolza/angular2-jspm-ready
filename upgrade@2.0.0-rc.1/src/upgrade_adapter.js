    ...
    UpgradeAdapter.prototype.bootstrap = function (element, modules, config) {
        ...
        ng1Module.run([
            ...
            function (injector, rootScope) {
                ...
                ng1compilePromise = ng2componentPromise.then(function () {
        ...
        ngZone.run(function () { ng2componentPromise = _this.compileNg2Components(compiler, componentFactoryRefMap); });
